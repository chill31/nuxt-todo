    ...
    <div class="flex w-screen flex-wrap items-start justify-center gap-4">
      <div v-for="todo, k in todos">
        ...
        <div
          ...
          <p class="[line-break:anywhere] h-[15ch] overflow-y-scroll text-sm whitespace-pre-line"
          ...
          <UButton icon="i-ic-baseline-check" color="transparent"
          ...
          <UButton icon="i-heroicons-trash" color="transparent"
            class="dark:text-red-500 text-red-600 dark:bg-inherit bg-slate-300 !p-1 focus:outline-current rounded-md hover:bg-white/10" size="sm"
            v-on:click="deleteTODO(k)"></UButton>
        </div>
      </div>
